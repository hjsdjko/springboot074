...
public class JiazhenggongsiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		JiazhenggongsiEntity u = jiazhenggongsiService.selectOne(new EntityWrapper<JiazhenggongsiEntity>().eq("gongsizhanghao", username));
    ...
    public R register(@RequestBody JiazhenggongsiEntity jiazhenggongsi){
    	...
    	JiazhenggongsiEntity u = jiazhenggongsiService.selectOne(new EntityWrapper<JiazhenggongsiEntity>().eq("gongsizhanghao", jiazhenggongsi.getGongsizhanghao()));
		if(u!=null) {
    ...
    public R page(@RequestParam Map<String, Object> params,JiazhenggongsiEntity jiazhenggongsi,
		...
		if(tableName.equals("jiazhenggongsi")) {
			jiazhenggongsi.setGongsizhanghao((String)request.getSession().getAttribute("username"));
		}
    ...
    public R save(@RequestBody JiazhenggongsiEntity jiazhenggongsi, HttpServletRequest request){
        if(jiazhenggongsiService.selectCount(new EntityWrapper<JiazhenggongsiEntity>().eq("gongsizhanghao", jiazhenggongsi.getGongsizhanghao()))>0) {
    ...
    public R update(@RequestBody JiazhenggongsiEntity jiazhenggongsi, HttpServletRequest request){
        //ValidatorUtils.validateEntity(jiazhenggongsi);
        if(jiazhenggongsiService.selectCount(new EntityWrapper<JiazhenggongsiEntity>().ne("id", jiazhenggongsi.getId()).eq("gongsizhanghao", jiazhenggongsi.getGongsizhanghao()))>0) {
            return R.error("公司账号已存在");
        }
